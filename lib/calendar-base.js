...
function Calendar (options) {
	...
	this.siblingMonths = options.siblingMonths || true;
...
Calendar.diff = function (date1, date2) {
	...
	oDate1.setFullYear(date1.year);
	oDate1.setMonth(date1.month);
	oDate1.setDate(date1.day);

	oDate2.setFullYear(date2.year);
	oDate2.setMonth(date2.month);
	oDate2.setDate(date2.day);
